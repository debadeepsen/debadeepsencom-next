...
const h2Class =
  'text-xl sm:text-3xl text-white inline-block text-[1.2rem] font-extralight relative shadow-[0px_2px_3px_#0004] -ml-10 mb-[30px] pl-5 p-2.5 before:content-[""] before:block before:absolute before:w-0 before:h-0 before:border-l-[none] before:border-l-[#0000] before:border-r-[#257] before:border-t-[#257] before:border-b-[#0000] before:border-solid before:border-[7px] before:left-0 before:-bottom-3.5 left-[-6px] top-[-10px]'
