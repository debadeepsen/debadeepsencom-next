      ...
      <div className='container'>
        ...
        <div className='projects'>
          ...
          <div className='project-block'>
            ...
            <div className='description'>
              A replication of some of the features offered by popular job
              search websites like Indeed, Monster, and others.
            </div>
            <div>
              <i className='fa fa-globe' aria-hidden='true' />{' '}
          ...
          <div className='project-block'>
            ...
            <div>
              <i className='las la-code' />{' '}
              <a
                href='https://github.com/debadeepsen/foodorder'
                target='_blank'
              >
          ...
          <div className='project-block'>
            ...
            <div>
              <i className='las la-code' />{' '}
              <a
                href='https://github.com/debadeepsen/vue-chess/'
                target='_blank'
              >
          ...
          <div className='project-block'>
            ...
            <div className='description'>
              ...
              between English and French. Uses the <code>nuxt-i18n</code>{' '}
              package.
            </div>
            <div>
              <i className='las la-code' />{' '}
